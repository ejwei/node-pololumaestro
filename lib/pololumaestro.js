...
PololuMaestro.prototype.setTarget = function(device, channel, us, onComplete) {
	...
	*/
	...
	this._sendCommandDevices(device, 0x04, channel, us, onComplete);
};
...
PololuMaestro.prototype._sendCommandDevices = function(device, command, channel, value, onComplete) {
